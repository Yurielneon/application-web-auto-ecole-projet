...
return [
    'defaults' => [
        'guard' => 'api',           // Garde par défaut pour l’API (JWT)
        'passwords' => 'administrators', // Broker de mot de passe pour les admins
    ],
    ...
    // 'passwords' => [
    //     'administrators' => [
    //         'provider' => 'administrators', // Fournisseur pour la réinitialisation
    //         'table' => 'password_reset_tokens', // Table pour les tokens de réinitialisation
    //         'expire' => 60,         // Durée de validité en minutes
    //     ],
    // ],
];
