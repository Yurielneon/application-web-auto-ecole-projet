...
const TrainingDetail: React.FC<{ trainingId: number }> = ({ trainingId }) => {
    ...
    if (loading) return <div className="p-6 text-gray-700 dark:text-gray-300">Chargement...</div>;
    if (error) return <div className="p-6 text-red-500">{error}</div>;
    if (!selectedTraining) return <div className="p-6 text-gray-500">Aucune formation sélectionnée</div>;
        ...
        <div className="p-6 max-w-7xl mx-auto bg-gray-50 dark:bg-gray-900 min-h-screen">
                    ...
                    <div className="flex-1 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-400">{selectedTraining.duration_weeks} semaines</p>
                            </div>
                            <div>
                                <Label className="text-lg font-semibold text-gray-800 dark:text-gray-200">Prix</Label>
                                <p className="text-gray-600 dark:text-gray-400">{selectedTraining.price} Ar</p>
                            </div>
                            <div>
            ...
            <Modal isOpen={isAddModalOpen} onClose={() => setIsAddModalOpen(false)} className="max-w-md p-6">
                ...
                <div className="flex justify-end gap-3 mt-6">
                    ...
                    <Button size="sm" onClick={handleAddCourse} disabled={!newCourseId}>
                        Ajouter
                    </Button>
                </div>
            </Modal>
            ...
            <Modal isOpen={isAddExamModalOpen} onClose={() => setIsAddExamModalOpen(false)} className="max-w-md p-6">
                ...
                <div className="flex justify-end gap-3 mt-6">
                    ...
                    <Button size="sm" onClick={handleAddExam} disabled={!Object.values(examValidation).every(Boolean)}>
                        Ajouter
                    </Button>
                </div>
            </Modal>
            ...
            <Modal isOpen={isEditExamModalOpen} onClose={() => setIsEditExamModalOpen(false)} className="max-w-md p-6">
                ...
                <div className="flex justify-end gap-3 mt-6">
                    ...
                    <Button size="sm" onClick={handleEditExam} disabled={!Object.values(examValidation).every(Boolean)}>
                        Sauvegarder
                    </Button>
                </div>
            </Modal>
